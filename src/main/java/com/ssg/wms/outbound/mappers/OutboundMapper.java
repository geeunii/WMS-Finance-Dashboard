...
public interface OutboundMapper {
    ...
    List<OutboundDTO> selectAllShipment(       @Param("userId") Long userId,
    ...
    List<OutboundDTO> selectOutboundRequestByUserId(@Param("userId") Long userId,
                                                    @Param("criteria") Criteria criteria,
                                                    @Param("status") String status);


    // 출고 요청 상세 조회 (서비스 getRequestDetailById와 연결)
    OutboundDTO getRequestDetailByUser(@Param("outboundRequestId") Long outboundRequestId,
