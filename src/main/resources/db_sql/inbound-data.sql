...
-- 3. Member (10건)
-- ===========================
INSERT INTO Member (member_login_id, member_pw, member_name, member_phone, member_email, partner_id) VALUES
                                                                                                         ('user01','pw01','홍길동','010-0000-0001','user01@example.com',1),
...
-- 4. Staff (10건)
-- ===========================
INSERT INTO Staff (staff_pw, staff_name, staff_phone, staff_email, staff_login_id) VALUES
                                                                                       ('pw101','김관리','010-1000-0001','staff01@example.com','staff01'),
...
INSERT INTO WAREHOUSE (admin_id, name, warehouse_type, warehouse_capacity, warehouse_status, registration_date, latest_update_date, address, latitude, longitude) VALUES
                                                                                                                                                                      (1,'강남창고','일반',1000,1,'2025-01-01',CURRENT_TIMESTAMP,'서울시 강남구',37.4979,127.0276),
...
-- 7. Product (10건)
-- ===========================
INSERT INTO Product (product_id, category_cd, partner_id, product_name, product_price, product_origin) VALUES
                                                                                                            ('P001',1,1,'나이키 아우터',100000,'USA'),
...
-- 8. inbound (10건)
-- ===========================
INSERT INTO inbound (warehouse_id, staff_id, member_id, inbound_status) VALUES
                                                                            (1,1,1,'request'),
                                                                            (2,2,2,'request'),
                                                                            (3,3,3,'request'),
                                                                            (4,4,4,'request'),
...
-- ===========================
INSERT INTO Product_Stock (warehouse_id, section_id, inbound_item_id, quantity, product_status) VALUES
                                                                                                    (1,1,1,10,'AVAILABLE'),
                                                                                                    (2,2,2,20,'AVAILABLE'),
                                                                                                    (3,3,3,15,'AVAILABLE'),
                                                                                                    (4,4,4,5,'AVAILABLE'),
...
-- ===========================
INSERT INTO Physical_Inventory (PS_ID, pi_date, pi_state, pid_quantity, real_quantity, different_quantity, update_state) VALUES
                                                                                                                             (1,CURRENT_TIMESTAMP,'START',10,10,0,'PENDING'),
...
-- ===========================
INSERT INTO product_stock_log (PS_ID, event_time, move_quantity, event_type, product_status, destination) VALUES
                                                                                                              (1,CURRENT_TIMESTAMP,10,'IN','AVAILABLE','Warehouse A'),
