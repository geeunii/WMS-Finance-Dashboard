...
<script>
    ...
    function searchStock(page) {
        ...
        const apiUrl = '/stock/list?' + queryString;
        ...
        fetch(apiUrl)
            ...
            .catch(error => {
                ...
                document.getElementById('stock-pagination-ul').innerHTML = ''; // 페이지네이션 초기화
    ...
    // 💡 추가된 코드: 페이지 로드 완료 시 초기 재고 목록을 가져오기 위해 searchStock(1) 호출
