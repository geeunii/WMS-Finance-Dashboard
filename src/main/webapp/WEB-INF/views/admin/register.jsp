            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2">RACL의 회원으로 함께해요 🚀</h4>
                    <p class="mb-4">창고 관리는 RACL에게 맡기세요!</p>
                    ...
                    <form id="formAuthentication" class="mb-3" action="index.html" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="email" name="email" placeholder="Email을 입력해주세요" />
                        </div>

                        <div class="mb-3">
                            <label for="businessnumber" class="form-label">Business Number</label>
                            <input type="text" class="form-control" id="businessnumber" name="businessnumber" placeholder="사업자등록번호를 입력해주세요" />
                        </div>

                        <button class="btn btn-primary d-grid w-100">회원가입 신청</button>
                    </form>
